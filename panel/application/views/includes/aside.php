            ...
            <ul class="app-menu">
                ...
                <li class="has-submenu">
                    ...
                    <ul class="submenu">
                        <li>
                            <a href="#">
                                <i class="menu-icon zmdi zmdi-collection-image-o"></i>
                                <span class="menu-text">Resim Galerisi</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="menu-icon zmdi zmdi-collection-video"></i>
                                <span class="menu-text">Video Galerisi</span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="menu-icon zmdi zmdi-collection-text"></i>
                ...
                <li>
                    <a href="javascript:void(0)">
                        <i class="menu-icon zmdi zmdi-play-circle-outline zmdi-hc-lg"></i>
                ...
                <li>
                    <a href="javascript:void(0)">
                        <i class="menu-icon zmdi zmdi-functions zmdi-hc-lg"></i>
                ...
                <li>
                    <a href="javascript:void(0)">
                        <i class="menu-icon zmdi zmdi-pin-account zmdi-hc-lg"></i>
                ...
                <li>
                    <a href="javascript:void(0)">
                        <i class="menu-icon zmdi zmdi-favorite zmdi-hc-lg"></i>
